            ...
            <div className="space-y-2">
              ...
              <Popover>
                <PopoverTrigger asChild>
                    <div className="flex min-h-10 w-full items-center gap-2 rounded-md border border-input bg-transparent px-3 py-2 text-sm">
                        {user.roles.map(role => (
                         ...
                         <span className="text-muted-foreground">{user.roles.length === 0 ? "請點擊以選擇角色" : ""}</span>
                    </div>
                </PopoverTrigger>
