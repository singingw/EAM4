...
const statusMap: { [key: string]: { label: string; className: string } } = {
  已轉檔1: { label: "已轉檔1", className: "bg-blue-100 text-blue-800" },
  已轉檔2: { label: "已轉檔2", className: "bg-blue-100 text-blue-800" },
  已轉檔3: { label: "已轉檔3", className: "bg-blue-100 text-blue-800" },
                    ...
                    <TableCell className="space-x-1">
                      ...
                      {showFunctions ? (
                        <>
                          ...
                          {item.status.startsWith('已轉檔') || item.status === '待放行' ? (
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent>
                            ...
                            <DropdownMenuItem className="text-orange-600">
                                {item.status.startsWith('已轉檔') || item.status === '待放行' ? <Eye className="mr-2 h-4 w-4" /> : <FileOutput className="mr-2 h-4 w-4" />}
                                {item.status.startsWith('已轉檔') || item.status === '待放行' ? '預覽檢貨單' : '匯出檢貨單'}
                            </DropdownMenuItem>
                            {item.status === '待放行' && (
                                <DialogTrigger asChild>
