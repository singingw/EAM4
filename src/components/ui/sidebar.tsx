    ...
    return (
      ...
      >
        ...
        <div
          ...
          {...props}
        >
          <div className="flex h-full w-full flex-col bg-background group-data-[variant=inset]:rounded-lg group-data-[variant=inset]:border group-data-[variant=inset]:shadow">
            {children}
          </div>
        </div>
      </div>
